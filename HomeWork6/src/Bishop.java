public class Bishop extends ChessPiece {
    Bishop() {
        this.chessPieceColor = 'i';
    }

    public void printMaxRooks()	{
        System.out.println("maximum number of Bishops = " + maxNoOfPieces );
    }
    ...
    public void placeBishop(int startC, int startR, Board2D board2D)	{
