...
class SortedStorage{
    ...
    Node addRecursively(Node root, Integer value){
        if(root == null){
            root = new Node(value);
            return root;
        }
    ...
    Node addRecursively(Node root, Long value){
        if(root == null){
            root = new Node(value);
            return root;
        }
        if(root.longValue <=  value){
            root.right = addRecursively(root.right, value);
        }
        else {
            root.left = addRecursively(root.left, value);
     ...
     */
    Node addRecursively(Node root, String value){
        if(root == null){
            root = new Node(value);
            return root;
        }
        if(Integer.parseInt(root.value) <=  Integer.parseInt(value)){
            root.right = addRecursively(root.right, value);
        }
